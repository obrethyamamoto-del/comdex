...
const LEGAL_DOCS: Record<string, { title: string; icon: React.ElementType; content: React.ReactNode }> = {
    terms: {
        ...
        content: (
            <div className="space-y-8">
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">1. Introduction</h3>
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">2. Eligibility</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">3. Account Registration</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                        To access certain features, you may be required to register an account. You agree to provide accurate, current, and complete information during the registration process and to update such information to keep it accurate, current, and complete. You are responsible for safeguarding your password and for all activities that occur under your account.
                    </p>
                </section>
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">4. Tokenized Assets</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">5. User Conduct</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">6. Termination</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
    ...
    privacy: {
        ...
        content: (
            <div className="space-y-8">
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">1. Data Collection</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">2. Use of Information</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">3. Blockchain Data</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">4. Data Security</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">5. Your Rights</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
    ...
    cookies: {
        ...
        content: (
            <div className="space-y-8">
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">1. What are Cookies?</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">2. How We Use Cookies</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">3. Types of Cookies We Use</h3>
                    <ul className="list-disc pl-5 text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed space-y-2">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">4. Managing Cookies</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
    ...
    risk: {
        ...
        content: (
            <div className="space-y-8">
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">1. General Trading Risks</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">2. Regulatory Risk</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">3. Technology Risk</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <section>
                    <h3 className="text-xl font-black text-slate-950 dark:text-white mb-4">4. No Financial Advice</h3>
                    <p className="text-slate-500 dark:text-slate-400 dark:text-slate-500 font-medium leading-relaxed">
                ...
                <div className="max-w-[1500px] mx-auto px-4 md:px-10 py-8 md:py-12">
                    ...
                    <div className="flex items-center justify-between mb-12">
                        <Link href="/" className="flex items-center gap-2 group transition-all">
                            ...
                            <span className="text-[11px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest group-hover:text-slate-900 dark:text-slate-100 transition-colors">Back to Home</span>
                        </Link>
                        <h1 className="text-3xl md:text-4xl font-black text-slate-950 dark:text-white tracking-tight">Legal Center</h1>
                    </div>

                    <div className="flex flex-col lg:flex-row gap-8 pb-20">
                        {/* Sidebar */}
                        <aside className={cn(
                            "fixed inset-y-0 left-0 z-50 w-80 bg-white dark:bg-slate-950 border-r border-slate-100 dark:border-slate-800 p-6 transform transition-transform duration-300 lg:relative lg:translate-x-0 lg:w-80 lg:bg-transparent dark:bg-transparent lg:border-none lg:p-0 lg:block",
                            isSidebarOpen ? "translate-x-0 shadow-2xl" : "-translate-x-full"
                        )}>
                            <div className="flex items-center justify-between lg:hidden mb-8">
                                <span className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Legal Menu</span>
                                ...
                                {Object.entries(LEGAL_DOCS).map(([key, doc]) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            activeDoc === key
                                                ? "bg-white dark:bg-slate-900/50 border-slate-200 dark:border-slate-700 shadow-[0_10px_20px_rgba(0,0,0,0.03)]"
                                                : "bg-transparent dark:bg-transparent border-transparent hover:bg-slate-50 dark:hover:bg-slate-900/30 hover:border-slate-50 dark:hover:border-slate-800"
                                        )}
                                    >
                                        <div className={cn(
                                            "w-10 h-10 rounded-xl flex items-center justify-center transition-colors",
                                            activeDoc === key ? "bg-slate-950 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 group-hover:bg-white dark:bg-slate-950 group-hover:text-slate-600 dark:text-slate-300 dark:text-slate-600"
                                        )}>
                                        ...
                                        <div className="flex flex-col">
                                            <span className={cn(
                                                ...
                                                activeDoc === key ? "text-slate-950 dark:text-white" : "text-slate-500 dark:text-slate-400 dark:text-slate-500 group-hover:text-slate-900 dark:text-slate-100"
                                            )}>
                                                {doc.title}
                                            </span>
                                        </div>
                        ...
                        <div className="lg:hidden flex items-center justify-between bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 p-4 rounded-2xl mb-6">
                            <span className="text-sm font-bold text-slate-900 dark:text-slate-100">{currentDoc.title}</span>
                            <button
                                onClick={() => setIsSidebarOpen(true)}
                                className="p-2 bg-slate-50 dark:bg-slate-900 rounded-lg text-slate-500 dark:text-slate-400 dark:text-slate-500"
                            >
                        ...
                        <main className="flex-1 min-w-0">
                            <div className="bg-white dark:bg-slate-900/40 border border-slate-100 dark:border-slate-800 rounded-[32px] md:rounded-[48px] p-8 md:p-12 shadow-sm min-h-[600px] relative overflow-hidden">
                                {/* Decorative Blur */}
                                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-slate-50 dark:bg-slate-900/50 rounded-full blur-[100px] pointer-events-none" />
                                ...
                                >
                                    <header className="flex flex-col gap-4 border-b border-slate-100 dark:border-slate-800 pb-8">
                                        ...
                                        <h2 className="text-3xl md:text-5xl font-black text-slate-950 dark:text-white tracking-tight leading-none">
                                            {currentDoc.title}
                                        </h2>
                                        <p className="text-slate-400 dark:text-slate-500 font-bold text-[11px] uppercase tracking-[0.2em]">
                                    ...
                                    <div className="pt-12 mt-12 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6">
                                        <p className="text-slate-400 dark:text-slate-500 text-xs font-medium max-w-md">
