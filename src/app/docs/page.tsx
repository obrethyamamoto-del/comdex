...
function GettingStartedSteps() {
    const steps = [
        ...
        },
        {
            ...
            desc: "Swap your USDT into AUSD, our gold-backed settlement engine for all trades.",
            icon: ArrowRightLeft,
            color: "emerald"
        },
        {
                        ...
                        <div key={i} className="relative group/step">
                            <div className="flex flex-col gap-8 p-8 bg-slate-50/50 border border-slate-100 rounded-[32px] hover:bg-white hover:shadow-[0_30px_60px_rgba(0,0,0,0.05)] hover:border-slate-200 transition-all duration-500 h-full">
                                ...
                                <div className="pt-4 mt-auto">
                                    <Link href="/earn">
                                        <button className="text-[11px] font-black text-slate-950 hover:text-indigo-600 uppercase tracking-widest flex items-center gap-2 transition-colors">
...
function PageMain() {
    ...
    const [activeTab, setActiveTab] = useState<'support' | 'docs'>('docs');
    ...
    useEffect(() => {
        ...
        if (query) {
            ...
            // Don't auto-switch to support on docs page unless explicit
        }
